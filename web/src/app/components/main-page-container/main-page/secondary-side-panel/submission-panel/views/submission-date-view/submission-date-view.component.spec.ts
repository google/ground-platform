...
describe('SubmissionDateViewComponent', () => {
  let fixture: ComponentFixture<SubmissionDateViewComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [SubmissionDateViewComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(SubmissionDateViewComponent);
  });
