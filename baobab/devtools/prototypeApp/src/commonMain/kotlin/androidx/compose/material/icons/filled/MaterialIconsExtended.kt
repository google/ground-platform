...
public val Icons.Filled.SatelliteAlt: ImageVector
  get() {
    if (_satelliteAlt != null) return _satelliteAlt!!
    _satelliteAlt =
      materialIcon(name = "Filled.SatelliteAlt") {
        materialPath {
          moveTo(15.44f, 0.86f)
          ...
          curveToRelative(0.78f, -0.78f, 0.78f, -2.05f, 0.0f, -2.83f)
          lineTo(18.27f, 0.86f)
          curveTo(17.49f, 0.08f, 16.22f, 0.08f, 15.44f, 0.86f)
          close()
        }
      }
...
public val Icons.Filled.PictureAsPdf: ImageVector
  get() {
    ...
    _pictureAsPdf =
      materialIcon(name = "Filled.PictureAsPdf") {
        materialPath {
          moveTo(20.0f, 2.0f)
          horizontalLineTo(8.0f)
          curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f)
...
public val Icons.Filled.Polyline: ImageVector
  get() {
    ...
    _polyline =
      materialIcon(name = "Filled.Polyline") {
        materialPath {
          moveTo(15.0f, 16.0f)
    ...
    _lightMode =
      materialIcon(name = "Filled.LightMode") {
        materialPath {
          ...
          verticalLineToRelative(-2.0f)
          curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f)
          reflectiveCurveTo(11.0f, 19.45f, 11.0f, 20.0f)
          close()
        }
      }
    return _lightMode!!
...
public val Icons.Filled.ScreenRotation: ImageVector
  get() {
    if (_screenRotation != null) return _screenRotation!!
    _screenRotation =
    ...
    _link =
      materialIcon(name = "Filled.Link") {
        materialPath {
          ...
          reflectiveCurveTo(4.24f, 17.0f, 7.0f, 17.0f)
          horizontalLineTo(11.0f)
          ...
          reflectiveCurveTo(18.71f, 15.1f, 17.0f, 15.1f)
          horizontalLineTo(13.0f)
...
public val Icons.Filled.CloudDone: ImageVector
  get() {
    if (_cloudDone != null) return _cloudDone!!
    _cloudDone =
      materialIcon(name = "Filled.CloudDone") {
        materialPath {
          moveTo(19.35f, 10.04f)
          curveTo(18.67f, 6.59f, 15.64f, 4.0f, 12.0f, 4.0f)
          curveTo(9.11f, 4.0f, 6.6f, 5.64f, 5.35f, 8.04f)
