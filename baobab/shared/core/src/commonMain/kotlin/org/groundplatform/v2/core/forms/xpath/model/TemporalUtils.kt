 ...
 * arithmetic and XForms date formatting (`format-date`, `format-date-time`, `decimal-date-time`,
...
internal object TemporalUtils {
  ...
  /**
   * Formats a date or date-time using XForms `format-date` / `format-date-time` pattern tokens:
   * - `%Y`: 4-digit year
   * - `%y`: 2-digit year
