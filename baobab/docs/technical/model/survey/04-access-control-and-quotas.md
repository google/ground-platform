...
| `DATA_COLLECTOR`   | Field enumerator or desk photo-interpreter authorized to collect submissions and |
...
`max_questions_per_form`              | 10         | 50
`max_photo_questions_per_form`        | 1          | 10
